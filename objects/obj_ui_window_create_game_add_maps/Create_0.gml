...
mapselection = create_ui(0, 0, obj_ui_mapselection)
mapselection.width = width - 20
mapselection.height = height - 40

ui_window_add_element(mapselection, 10, 30)

scrollbar = create_ui(0, 0, obj_ui_scrollbar)
scrollbar.width = 15
scrollbar.height = mapselection.height - 20
